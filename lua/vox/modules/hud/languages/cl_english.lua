...
LANG[ 'hud.theme.default.name' ] = 'Vox Obsidian'
LANG[ 'hud.theme.vox_obsidian.name' ] = 'Vox Obsidian'
LANG[ 'hud.theme.vox_midnight.name' ] = 'Vox Midnight'
LANG[ 'hud.theme.vox_royal_purple.name' ] = 'Vox Royal Purple'
LANG[ 'hud.theme.vox_carbon_red.name' ] = 'Vox Carbon Red'
LANG[ 'hud.theme.vox_emerald.name' ] = 'Vox Emerald'
LANG[ 'hud.theme.vox_gold.name' ] = 'Vox Gold'
LANG[ 'hud.theme.vox_light.name' ] = 'Vox Light'
LANG[ 'hud.theme.custom_accent.name' ] = 'Custom Accent'
...
vox.lang:AddPhrases( 'english', LANG )
