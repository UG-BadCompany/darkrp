...
local function paintCommandCard(panel, w, h, accent, title, desc, locked)
...
function INV:Init()
    ...
    for _, data in ipairs(items) do
        ...
        card.Paint = function(panel, w, h) paintCommandCard(panel, w, h, data[3], data[1], data[2], data[4]) end
    end
end
...
function SET:Init()
    ...
    for _, data in ipairs(rows) do
        ...
        card:SetText('')
        card:SetTall(vox.ScaleTall(108))
        card.Paint = function(panel, w, h) paintCommandCard(panel, w, h, data[3], data[1], data[2]) end
