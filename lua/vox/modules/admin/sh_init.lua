...
local function registerDefaultActions()
    ...
    A:RegisterAction('drc_compliance', { name = 'DRC Compliance (Jail)', category = 'Punishments', description = 'Jail a player in Department of Roleplay Compliance.', reason = true })
