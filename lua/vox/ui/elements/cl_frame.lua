...
function PANEL:Paint(w, h)
    ...
    if (self.focused and self.focusMultiplier > 0) then
        DisableClipping(true)
            vox.DrawBlurExpensive(self, self.focusMultiplier)
...
vox.gui.Register('vox.Frame', PANEL, 'EditablePanel')

-- ANCHOR Test

-- vox.gui.Test('vox.Frame', .65, .65, function(self)
--     self:Focus()
-- end)
