...
vox.premium = vox.command -- Backwards-compatible alias for older renderer callers.
...
vox.PremiumPalette = vox.CommandPalette -- Backwards-compatible alias.
...
vox.DrawVoxPremiumCard = vox.DrawVoxCommandCard -- Backwards-compatible alias.
