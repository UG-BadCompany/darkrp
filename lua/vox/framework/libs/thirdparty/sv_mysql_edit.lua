...
function DATABASE:OnConnected()
	...
	hook.Run("vox.DatabaseConnected", self:GetName())
end
...
function DATABASE:OnConnectionFailed(errorText)
	...
	hook.Run("vox.DatabaseConnectionFailed", self:GetName(), errorText)
end
...
function vox.sql.Create(moduleName, name, data)
    ...
    timer.Create('vox.sql.QueueProcessor_' .. name, .1, 0, function()
